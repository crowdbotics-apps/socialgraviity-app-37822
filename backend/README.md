...
## Project Structure
    ...
    ├── socialgraviity_app_37822  # Django project configurations
...
1. Clone this repo and `cd socialgraviity_app_37822`
...
2. Clone this repo and `cd socialgraviity_app_37822`
